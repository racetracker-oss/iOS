    ...
    var body: some View {
        ZStack {
            VStack(spacing: 30){
                ZStack {
                    // S3
                    SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS3, color: .orange, lineWidth: lineWidth)
                    
                    // S2
                    SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS2, color: .green, lineWidth: lineWidth)
...
#Preview {
    ZStack{
        ...
        CustomProgressView(lineWidth: 12, height: 120, width: 120)
    }
}
